        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnginNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportRegister", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportRegister_Vehicle_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentSession_Employee_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportSchedule_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportSchedule_Vehicle_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AgentSessionId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentBreak", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentBreak_AgentSession_AgentSessionId",
                        column: x => x.AgentSessionId,
                        principalTable: "AgentSession",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentBreak_BreakType_BreakTypeId",
                        column: x => x.BreakTypeId,
                        principalTable: "BreakType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentBreak_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentBreak_AgentSessionId",
                table: "AgentBreak",
                column: "AgentSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentBreak_BreakTypeId",
                table: "AgentBreak",
                column: "BreakTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentBreak_EmployeeId",
                table: "AgentBreak",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentSession_EmployeeId",
                table: "AgentSession",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportRegister_VehicleId",
                table: "TransportRegister",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportSchedule_EmployeeId",
                table: "TransportSchedule",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportSchedule_VehicleId",
                table: "TransportSchedule",
                column: "VehicleId");
